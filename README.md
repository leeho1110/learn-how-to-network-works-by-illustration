...
- ***Q. TCP는 네트워크에 문제가 생겼다는 것을 확인할까요?***
    ...
    - ***Q. TCP의 혼잡 제어 알고리즘들에 대해 설명해주세요.***
        ...
        - TCP Reno
            ...
            >  _TCP Reno = TCP Tahoe + Fast Recovery_

            TCP Reno는 TCP Tahoe가 갖고 있던 2단계 페이징을 통한 혼잡 제어에 Fast Recovery를 더한 확장판이라고 볼 수 있습니다. Tahoe와의 차이점은 패킷 손실을 감지했을 때 Slow Start가 아닌 AIMD 단계를 재시작한다는 것입니다.